...
class Product(Basemodel):
    ...
    brand = models.ForeignKey(Brand, on_delete=models.CASCADE, related_name="product_brand", null=True)
    fabric = models.ForeignKey(Fabric, on_delete=models.CASCADE, related_name="fabric", default='Unknown', null=True)
    category = models.ForeignKey(Category, on_delete=models.CASCADE, related_name="products")
    actual_price = models.IntegerField()
    discount_percentage = models.IntegerField(null=True, blank=True, editable=False)
    discount_price = models.IntegerField(null=True, blank=True)
    product_description = models.TextField()
    color_variant = models.ForeignKey(ColorVariant, on_delete=models.CASCADE, related_name="color_variant", default='Unknown', null=True)
